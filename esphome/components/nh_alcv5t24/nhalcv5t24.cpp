...
namespace esphome {
    namespace nh_alcv5t24 {
        ...
        void NH_ALCV5T24::request_control_change(float value, nh_alcv5t24_light_control::NumberControlType controlType) {
            ESP_LOGD(TAG, "request_control_change: %f", value);
            switch(controlType) {
                case nh_alcv5t24_light_control::TURN_ON_BRIGHTNESS:
                    light_controller.change_on_value(value);
                    break;
                case nh_alcv5t24_light_control::TURN_OFF_BRIGHTNESS:
                    light_controller.change_off_value(value);
                    break;
            }
        }
